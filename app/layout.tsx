...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    return (
        ...
        <body className={`${inter.className} relative min-h-screen text-gray-900 dark:text-gray-100`}>
        {/* --- фон --- */}
        ...
        <Providers>
            ...
            <main className="pt-28 px-6 max-w-6xl mx-auto relative z-10 space-y-12 pb-32">
                {children}
            </main>
